...
const iOSData = [
  {
    title: "Amotion",
    imgUrl: "/assets/Amotions.png",
    stack: ["Swift", "Fire", "AVF"],
    link: "https://github.com/Amotions/iOSmvp",
    detail:
      "An app that track users daily journaling and provides videos to improves user emotional awareness. ",
  },
  {
    title: "Bulletin News",
    imgUrl: "/assets/BulletinNews.png",
    stack: ["Swift", "API"],
    link: "https://github.com/hubertle43100/UIDesign/tree/main/NewsAPI",
    detail: "Fetch the latest news and weather for your convince",
  },
  {
    title: "Need Seven",
